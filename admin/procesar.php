...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (count($usuarios_existentes) > 0) {
        ...
        $sql_insertar = "INSERT INTO usuarios (nombre, correo, dni, direccion, telefono, contrasena, clave, user_rol) 
                        VALUES ('$nombre', '$correo', '$dni', '$direccion', '$telefono', '$contrasenaHash', '$claveHash', '$rol')";
